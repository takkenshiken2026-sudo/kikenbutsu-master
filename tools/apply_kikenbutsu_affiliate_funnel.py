#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""学習系ガイドへ公開済み affiliate 比較記事の導線を追加する（危化物）。"""
...
AFFILIATE_TITLES = {
    "affiliate-textbooks-recommend": "危険物乙4のおすすめテキスト3選【2026年度版・独学・三領域】",
    "affiliate-problem-books": "危険物乙4のおすすめ問題集3選【2026年度版・三領域】",
    "affiliate-mock-exam-materials": "危険物乙4の予想・一問一答3選【ユーキャン・成美堂2026】",
    "affiliate-online-course-compare": "危険物乙4オンライン講座おすすめ2選｜オンスク.JPとSMART合格講座を比較",
}

BODY = {
    "affiliate-textbooks-recommend": (
        "テキスト1冊は、[おすすめテキスト3選](../affiliate-textbooks-recommend/) "
        "で三領域対応の3冊を比較してから固定すると、途中で乗り換えずに済みます。"
    ),
    "affiliate-problem-books": (
        "演習1冊は、[おすすめ問題集3選](../affiliate-problem-books/) "
        "で収録形式を比較してから35/50演習に組み込むと迷いが減ります。"
    ),
    "affiliate-mock-exam-materials": (
        "直前の短問演習は、[予想・一問一答3選](../affiliate-mock-exam-materials/) "
        "で一問一答と速習の違いを確認してから試験4週前のカレンダーに入れると安全です。"
    ),
    "affiliate-online-course-compare": (
        "独学が続かない場合は、[オンライン講座2選](../affiliate-online-course-compare/) "
        "でオンスク.JPとSMART合格講座を比較し、当サイト演習量は維持したまま1社に絞ると続きやすいです。"
    ),
}
...
GUIDE_AFFILIATE: dict[str, tuple[str, int]] = {
    ...
    "self-study-roadmap": ("affiliate-online-course-compare", 2),
    "self-study-start": ("affiliate-online-course-compare", 2),
...
SECONDARY_AFFILIATE: dict[str, str] = {
    ...
    "study-plan-working": "affiliate-problem-books",
