#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate write_kikenbutsu_hub_s40-s44_content.py."""
...
THEMES = [
    ("kiken-hoan", "危険物保安", "L", ("危険物保安監督者", "危険物取扱者"), "危険物保安;選任", "選任・解任時届出", ("危険物取扱者", "危険物保安監督者")),
    ("shobo-setsubi", "消防設備点検", "F", ("消火設備", "消火設備の区分"), "消防設備点検;消火設備", "定期点検（政令・規模次第）", ("消火設備", "消火活動")),
    ("shitei-suryo-santei", "指定数量算定", "L", ("指定数量", "指定数量の倍数"), "指定数量算定;第4類危険物", "品名別（政令・品名表）", ("指定数量", "指定数量の倍数")),
    ("chozo-sekkei", "貯蔵所設計", "L", ("タンク貯蔵所", "屋外タンク貯蔵所"), "貯蔵所設計;指定数量", "容量・倍数（政令確認）", ("屋外タンク貯蔵所", "屋内タンク貯蔵所の基準")),
    ("ido-toriatsukai", "移動取扱", "L", ("移動タンク貯蔵所", "タンクローリー"), "移動取扱;移送", "政令・品名表で確認", ("移動タンク貯蔵所", "タンクローリー")),
    ("yobo-kitei", "予防規程改定", "L", ("予防規程", "予防規程の作成"), "予防規程改定;火災予防", "作成・変更時（条文）", ("予防規程", "火災予防")),
    ("shoka-kunren", "消火訓練", "F", ("消火活動", "自衛消防組織"), "消火訓練;消火設備", "規模・用途で変動", ("自衛消防組織", "消火活動")),
    ("tank-kensa", "タンク検査", "L", ("タンクローリー", "移動タンク貯蔵所"), "タンク検査;定期検査", "政令・品名表で確認", ("タンクローリー", "移動タンク貯蔵所")),
    ("tensou-kiroku", "転送記録保存", "L", ("譲渡・引渡しの届出", "移送"), "転送記録;譲渡・引渡し", "政令・品名表確認", ("譲渡・引渡し", "移送")),
    ("ot4-chokuzen", "乙4直前", "L", ("乙種危険物取扱者", "危険物取扱者"), "乙4直前;試験要項", "要項で確認（年度により変動）", ("乙種危険物取扱者", "丙種危険物取扱者")),
]
